<div class="w-[20%] absolute top-0 left-0 min-h-screen z-30 bg-[#1A5276] border-r-[1px] border-[#fff]">
    ...
    <div class="w-full">
        <ul class="w-full">
            ...
            <a href="{{ url('/search') }}">
                <li style={{ Route::currentRouteName()=='__Search_index'?'background-color:#1687CF;color:#fff;':'background-color:#fff;color:#000;' }} class="w-full py-3 bg-white mt-1 flex px-10 items-center text-lg cursor-pointer hover:bg-[#1687CF] hover:text-white">Aramak</li>
            </a>
        </ul>
    </div>
